    ...
    <div class="card">
      ...
      <form action="{{ route('admin.equipment.store') }}" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" id="equipment_code" name="equipment_code" class="input @error('equipment_code') error-input @enderror" value="{{ old('equipment_code') }}" required>
        ...
        <div class="form-group">
          ...
          <input type="text" id="type" name="type" class="input @error('type') error-input @enderror" value="{{ old('type') }}" required>
          @error('type')
          <div class="error-msg">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input type="text" id="location" name="location" class="input @error('location') error-input @enderror" value="{{ old('location') }}" required>
          @error('location')
          <div class="error-msg">{{ $message }}</div>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input type="date" id="last_maintenance_date" name="last_maintenance_date" class="input @error('last_maintenance_date') error-input @enderror" value="{{ old('last_maintenance_date') }}">
